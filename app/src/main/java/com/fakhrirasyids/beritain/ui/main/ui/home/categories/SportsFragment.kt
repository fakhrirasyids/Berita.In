...
import com.fakhrirasyids.beritain.databinding.FragmentSportsBinding
...
class SportsFragment : Fragment() {
    ...
    private fun observeLoading() {
        homeViewModel.isLoadingSports.observe(viewLifecycleOwner) {
            showLoading(it)
        }
    }

    private fun setUpSportsNews() {
        homeViewModel.getLatestCategoryNews(Constants.SPORTS_CATEGORY)
        homeViewModel.sportsNews.observe(viewLifecycleOwner) { newsArticle ->
