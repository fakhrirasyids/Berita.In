...
class ScienceFragment : Fragment() {
    ...
    private fun observeLoading() {
        homeViewModel.isLoadingScience.observe(viewLifecycleOwner) {
            showLoading(it)
        }
    }

    private fun setUpScienceNews() {
        homeViewModel.getLatestCategoryNews(Constants.SCIENCE_CATEGORY)
        homeViewModel.scienceNews.observe(viewLifecycleOwner) { newsArticle ->
