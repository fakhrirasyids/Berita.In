...
import com.fakhrirasyids.beritain.databinding.FragmentTechnologyBinding
...
class TechnologyFragment : Fragment() {
    ...
    private fun observeLoading() {
        homeViewModel.isLoadingTechnology.observe(viewLifecycleOwner) {
            showLoading(it)
        }
    }

    private fun setUpTechnologyNews() {
        homeViewModel.getLatestCategoryNews(Constants.TECHNOLOGY_CATEGORY)
        homeViewModel.technologyNews.observe(viewLifecycleOwner) { newsArticle ->
