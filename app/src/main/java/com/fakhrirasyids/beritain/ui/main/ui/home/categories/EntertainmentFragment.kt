...
import com.fakhrirasyids.beritain.databinding.FragmentEntertainmentBinding
...
class EntertainmentFragment : Fragment() {
    ...
    private fun observeLoading() {
        homeViewModel.isLoadingEntertainment.observe(viewLifecycleOwner) {
            showLoading(it)
        }
    }

    private fun setUpEntertainmentNews() {
        homeViewModel.getLatestCategoryNews(Constants.ENTERTAINMENT_CATEGORY)
        homeViewModel.entertainmentNews.observe(viewLifecycleOwner) { newsArticle ->
